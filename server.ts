...
// NOTE: process.cwd() is used instead of import.meta.url-based resolution
// because esbuild bundles this file to CommonJS for production (dist/server.cjs),
// where import.meta.url is empty and crashes on startup. The server is always
// started from the project root, so process.cwd() is safe here.
